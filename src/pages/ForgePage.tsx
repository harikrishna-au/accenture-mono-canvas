...
import {
  ...
  FolderGit2, Briefcase, Award, ChevronLeft, ChevronRight, ChevronDown, Check, Plus, Trash2, Trophy, Wand2, Loader2, Copy, X, FileCode
} from "lucide-react";
                  ...
                  {step < STEPS.length - 1 ? (
                    ...
                    <button
                      ...
                      {saveStatus === "saving"
                        ...
                        : <><FileCode className="w-4 h-4" /> Save &amp; Generate LaTeX</>}
                    </button>
                  )}
                </div>
              </div>
