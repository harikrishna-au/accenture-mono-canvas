...
create table if not exists public.communication_questions (
  id text primary key,
...
drop policy if exists "Allow public read access" on public.communication_questions;
create policy "Allow public read access"
  on public.communication_questions
  for select
  using (true);

drop policy if exists "Allow service role full access" on public.communication_questions;
